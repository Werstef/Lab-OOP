...
public:
    ...
    double suma(double parametru1, double parametru2){
        return parametru1 + parametru2;
    }

    NrComplex* suma(NrComplex parametru1, NrComplex parametru2){
    ...
    double dif(double parametru1, double parametru2){
        return parametru1 - parametru2;
    }

    NrComplex* dif(NrComplex parametru1, NrComplex parametru2){
    ...
    double produs(double parametru1, double parametru2){
        return parametru1 * parametru2;
    }

    NrComplex* produs(NrComplex parametru1, NrComplex parametru2){
    ...
    double div(double parametru1, double parametru2){
        return parametru1 / parametru2;
    }

    NrComplex* div(NrComplex parametru1, NrComplex parametru2){
